...
; ------------------------------------------------------------------------------------------------------------- ;
CC_LoadCtrlCol          = CC_ScreenLoadCtrl + $00         ; start point in CC_LoadCtrlRow
CC_LoadCtrlAreaTop        = $03                           ; default start row of output area
CC_LoadCtrlAreaLe         = $03                           ; default start column of left  output area
CC_LoadCtrlAreaInfo       = $05                           ; default start column of info  output area
CC_LoadCtrlAreaRi         = $16                           ; default start column of right output area
CC_LoadCtrlRow          = CC_ScreenLoadCtrl + $01         ; screen row number
CC_LoadCtrlRowDynMin      = ScreenLineGame  + $02         ; start row of file name area after fix area
CC_LoadCtrlRowDynMax      = $18                           ; end   row of file name area at bottom aof screen
CC_LoadCtrlId           = CC_ScreenLoadCtrl + $02         ; entry type id
...
CC_LoadCtrlNoResume       = $00                           ; control table entry number - resume saved game
CC_LoadCtrlNoTimes        = $01                           ; control table entry number - view high scores
CC_LoadCtrlNoLives        = $02                           ; control table entry number - unlimited lives on/off
CC_LoadCtrlNoExit         = $03                           ; control table entry number - exit load screen
CC_LoadCtrlNoFile         = $04                           ; control table entry number - first file name

CC_LoadCtrlFiNamLen     = CC_ScreenLoadCtrl + $03         ; entry length for type CC_LoadCtrlIdFile name
CC_LoadCtrlFiMaxLen       = $0f                           ; max len CC_LoadCtrlIdFile name

CC_LoadCtrlEntryLen       = $04                           ; length of each table entry

CC_LoadCtrlCrsrCol      = CC_ScreenLoadCtrl + $08         ; initial cursor position to type CC_LoadCtrlExit CC_LoadCtrlCol
CC_LoadCtrlCrsrRow      = CC_ScreenLoadCtrl + $09         ; initial cursor position to type CC_LoadCtrlExit CC_LoadCtrlRow
; ------------------------------------------------------------------------------------------------------------- ;
