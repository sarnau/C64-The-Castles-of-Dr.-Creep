...
TextExit                dc.b $10                        ; StartPos  : PosX = 10
                        ...
                        dc.b $00                        ; EndOfText = 00
; ------------------------------------------------------------------------------------------------------------- ;
;TextIOError             dc.b $3c                        ; StartPos  : PosX = 3c - .hbu020.
...
;                        dc.b $00                        ; EndOfText = 00
; ------------------------------------------------------------------------------------------------------------- ;
;TextSaveGame            dc.w RoomTextLine               ; .hbu020.
;                        
...
;                        dc.b $00
; ------------------------------------------------------------------------------------------------------------- ;
;TextResumeGame          dc.w RoomTextLine               ; .hbu020.
;                        
...
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineHeader        = $00                           ; screen line header 
ScreenLineHeaderLen       = $03                         ; screen line header length
ScreenLineCol           = $00                           ; screen line column
ScreenLineRow           = $01                           ; screen line row
ScreenLineRowTop          = CC_LoadCtrlRowFixMin        ; offset of top line
ScreenLineId            = $02                           ; control table entry id number
ScreenLineIdLives         = CC_LoadCtrlIdLives          ; $00
ScreenLineIdExit          = CC_LoadCtrlIdExit           ; $01
ScreenLineIdResume        = CC_LoadCtrlIdResume         ; $03
ScreenLineIdTimes         = CC_LoadCtrlIdTimes          ; $04
ScreenLineIdNoSelect      = $ff                         ; info line: not cursor selectable
ScreenLineDataEnd       = $ff                           ; flag: end of text screen data 
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineData          = *                             ; texts for level / options select screen
ScreenLineJoyMov        = ScreenLineRowTop              ; load screen row number
ScreenLineJoyMovLoc     = CC_LoadCtrlColAreaHdr         ; 
...
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineJoySel        = ScreenLineJoyMov + $01        ; load screen row number
ScreenLineJoySelLoc     = CC_LoadCtrlColAreaHdr         ; 
...
; ------------------------------------------------------------------------------------------------------------- ;
;ScreenLineResume        = ScreenLineJoySel + $02        ; load screen row number - .hbu020.
;ScreenLineResumeLoc     = CC_LoadCtrlColAreaLe          ; 
...
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineTimes         =  ScreenLineJoySel + $02       ; load screen row number
;ScreenLineTimesLoc      =  CC_LoadCtrlColAreaRi         ; .hbu020. 
ScreenLineTimesLoc      =  CC_LoadCtrlColAreaLe         ; .hbu020.
...
;ScreenLineTimesTxt      dc.b $56 ; v                    ; view best timeS - .hbu020.
;                        dc.b $49 ; i
;                        dc.b $45 ; e
;                        dc.b $57 ; w
;                        dc.b $20 ; _
ScreenLineTimesTxt      dc.b $42 ; b                    ; .hbu020.
                        dc.b $45 ; e
                        dc.b $53 ; s
                        dc.b $54 ; t
                        dc.b $20 ; _
...
; ------------------------------------------------------------------------------------------------------------- ;
;ScreenLineLives         =  ScreenLineResume + $01       ; load screen row number - .hbu020.
;ScreenLineLivesLoc      =  CC_LoadCtrlColAreaLe         ; 
ScreenLineLives         =  ScreenLineTimes              ; .hbu020. - load screen row number
ScreenLineLivesLoc      =  CC_LoadCtrlColAreaRi         ; 
...
;                        dc.b $45 ; e
;                        dc.b $53 ; s
ScreenLineLivesTxt      dc.b $54 ; t                    ; training (on/off)
                        dc.b $52 ; r
                        dc.b $41 ; a
                        dc.b $49 ; i
                        dc.b $4e ; n
...
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineExit          = ScreenLineLives + $01         ; load screen row number
ScreenLineExitLoc       = CC_LoadCtrlColAreaLe          ; 
...
; ------------------------------------------------------------------------------------------------------------- ;
ScreenLineGame          = ScreenLineExit + $01          ; load screen row number - .hbu020.
;ScreenLineGame          = ScreenLineExit + $02          ; load screen row number - .hbu020.
;ScreenLineGameLoc       = CC_LoadCtrlColAreaLe          ; 
