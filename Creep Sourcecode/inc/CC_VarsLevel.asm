...
; Players Life
; ------------------------------------------------------------------------------------------------------------- ;
CCL_PlayersNumLives     = CC_LevelGameVars + $07    ; number of lives left - 00=dead
CCL_PlayersLivesMin       = $00                     ; 
CCL_PlayersLivesMax       = $03                     ; 
CCL_Player1NumLives     = CC_LevelGameVars + $07    ; player1
CCL_Player2NumLives     = CC_LevelGameVars + $08    ; player2
; ------------------------------------------------------------------------------------------------------------- ;
; Players Target
; ------------------------------------------------------------------------------------------------------------- ;
CCL_PlayersTargetRoomNo = CC_LevelGameVars + $09    ; players target room number
CCL_Player1TargetRoomNo = CC_LevelGameVars + $09    ; count start: entry 00 of ROOM list
CCL_Player2TargetRoomNo = CC_LevelGameVars + $0a    ; count start: entry 00 of ROOM list

CCL_PlayersTargetDoorNo = CC_LevelGameVars + $0b    ; players target door number in target room
CCL_Player1TargetDoorNo = CC_LevelGameVars + $0b    ; count start: entry 00 of Room DOOR list
CCL_Player2TargetDoorNo = CC_LevelGameVars + $0c    ; count start: entry 00 of Room DOOR list
; ------------------------------------------------------------------------------------------------------------- ;
; Players Position
; ------------------------------------------------------------------------------------------------------------- ;
CCL_PlayersAtDoor       = CC_LevelGameVars + $0d    ; Players door position
CCL_Player1AtDoor       = CC_LevelGameVars + $0d    ; Player 1 in front of door
CCL_Player2AtDoor       = CC_LevelGameVars + $0e    ; Player 2 in front of door
; ------------------------------------------------------------------------------------------------------------- ;
; Players Status
; ------------------------------------------------------------------------------------------------------------- ;
